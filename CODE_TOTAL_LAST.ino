...
char ssid[] = "CAD-Hi-Tech-2.4G";      //ชื่อ Wi-Fi รองรับคลื่น 2.4GHz เท่านั้น
...
String GAS_ID = "AKfycbwWcEkXQglNLvvqpc_g5BYO2-xIhil3SkxoXFy76_42Bu8GKjteOXdrGXLXkAYwOg";  //Google Script id from deploy app
//==============Senddata2GGSheet===============//
