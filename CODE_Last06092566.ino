...
#define BLYNK_TEMPLATE_ID "TMPL6AjPxdfea" //นำมาจากอีเมล์ที่ Blynk ส่งให้
#define BLYNK_TEMPLATE_NAME "MySmartFarm" //นำมาจาก Blynk
#define BLYNK_AUTH_TOKEN "MQbNEUYlrD-t_wauSHMthTpSEgPYLmCk" //นำมาจาก Blynk
