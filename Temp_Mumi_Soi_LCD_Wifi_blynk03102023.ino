/*************************************************************************************************
    ...
    Update On:  03 October, 2023
     *  *********************************************************************************************
Map Blynk VirtualPin Relay 4 ตัว
V1 Relay Channel 1 
V2 Relay Channel 2
V3 Relay Channel 3
V4 Relay Channel 4
...
#define BLYNK_TEMPLATE_NAME "IOT SmartFarm"
...
TaskHandle_t Task2;
TaskHandle_t Task3;
//TaskHandle_t Task4;  //MQ4-Methane to Blynk 2.0
...
#define DHTPIN 18  //DHT22 ต่อเข้าขา 18 ของ ESP32
//#define DHTTYPE DHT11
#define DHTTYPE DHT22
DHT dht(DHTPIN, DHTTYPE);
//======Workshop4-SoilMoisture sensor=======//
#define INPUT_1 35 // ขา 35 กำหนดให้เป็น input
//=======Workshpp5-MQ4 Methane Gas==========//
//#define INPUT_2 34 // ขา 34 กำหนดให้เป็น input Gas
...
void setup() {
  ...
  pinMode(relay1, OUTPUT);  //กำหนดให้ pinmod relay เป็น output
  pinMode(relay2, OUTPUT);  //กำหนดให้ pinmod relay เป็น output
  pinMode(relay3, OUTPUT);   //กำหนดให้ pinmod relay เป็น output
  pinMode(relay4, OUTPUT);  //กำหนดให้ pinmod relay เป็น output
